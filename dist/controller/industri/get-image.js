...
function getIndustriImageById(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, result, industri, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = req.params.id;
                    result = [];
                    return [4 /*yield*/, industri_1.ModuleIndustri.getIndustriImageById(id)];
                case 1:
                    industri = _a.sent();
...
exports.default = getIndustriImageById;
